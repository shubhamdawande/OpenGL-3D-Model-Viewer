...
public class Renderer implements GLSurfaceView.Renderer
{
	...
	public static float deltaX = 0, deltaY = 0;
	...
	protected void drawObject(Object3d $o)
	{
		...
		*/
		...
		// custom code
		_gl.glScalef($o.scale().x * RendererActivity.sizeCoef, $o.scale().y * RendererActivity.sizeCoef, $o.scale().z * RendererActivity.sizeCoef);
		_gl.glRotatef(deltaX,0,1,0);
		_gl.glRotatef(deltaY,1,0,0);
