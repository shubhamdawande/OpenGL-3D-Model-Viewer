...
import com.ssd.modelrenderer3d.MainActivity;
import com.ssd.modelrenderer3d.MenuActivity;
...
public class RendererActivity extends Activity implements ISceneController
{
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
        ...
        // pinch zoom gesture listener
        mDetector = new ScaleGestureDetector(_glSurfaceView.getContext(), new ScaleDetectorListener());
	}
	...
	private class ScaleDetectorListener implements ScaleGestureDetector.OnScaleGestureListener{
		...
		public boolean onScale(ScaleGestureDetector arg0) {
			sizeCoef = arg0.getScaleFactor() * sizeCoef;
