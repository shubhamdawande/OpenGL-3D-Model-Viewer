...
public class Cube extends PrimitiveShape{
    ...
    public void draw(float[] mMVPMatrix) {
        ...
        GLES30.glDrawArrays(GLES30.GL_TRIANGLES, startPos, 2*COORDS_PER_VERTEX);
        startPos += 2*COORDS_PER_VERTEX;
        ...
        GLES30.glUniform4fv(mColorHandle, 1, grayColor, 0);
        GLES30.glDrawArrays(GLES30.GL_TRIANGLES, startPos, 2*COORDS_PER_VERTEX);
        startPos += 2*COORDS_PER_VERTEX;

        GLES30.glUniform4fv(mColorHandle, 1, cyanColor, 0);
        GLES30.glDrawArrays(GLES30.GL_TRIANGLES, startPos, 2*COORDS_PER_VERTEX);
        startPos += 2*COORDS_PER_VERTEX;
